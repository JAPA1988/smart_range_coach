    ...
    class _SwingReviewScreenState extends State<SwingReviewScreen> {
      ...
      Widget build(BuildContext context) {
        return Scaffold(
          appBar: AppBar(title: Text('Swing Review')),
          body: Center(
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                onPressed: _markedPositions.length == 7 ? () {/* TODO: Go to comparison */} : null,
...
class _SwingReviewScreenState extends State<SwingReviewScreen> {
  ...
  void initState() {
    super.initState();
    // Replace with your actual video path property
    _videoController = VideoPlayerController.asset(widget.userSwing.videoPath)
      ..initialize().then((_) {
        setState(() {});
      });
